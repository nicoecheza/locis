  ...
  describe('Clients Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (ClientsService) {
        ...
        expect($state.go).toHaveBeenCalledWith('clients.view', {
    ...
    describe('vm.save() as update', function () {
      ...
      it('should set $scope.vm.error if error', inject(function (ClientsService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the Client and redirect to Clients', function () {
        ...
        expect($state.go).toHaveBeenCalledWith('clients.list');
      });
